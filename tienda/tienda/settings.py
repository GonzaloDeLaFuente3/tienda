# Actualización importante en tienda/tienda/settings.py
# El problema puede estar en el orden de INSTALLED_APPS y configuración de Cloudinary
...
# Configuración de aplicaciones - ORDEN IMPORTANTE
INSTALLED_APPS = [
    ...
    "cloudinary_storage",  # DEBE ir antes que cloudinary
    "cloudinary",          # DEBE ir después de cloudinary_storage
    "products",
]
